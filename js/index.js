...
//   // TODO: Write less code than below solutions

//   //----------------------------------------------Tibetan Specialties

//   //appen to let foodMenu
//   let divTypeTS = document.createElement("div");
//   divTypeTS.classList.add("food__menu--type");

//   divTypeTS.textContent = "Tibetan Specialties";
//   let itemHolderUl = document.createElement("ul");
//   itemHolderUl.classList.add("collapsible");
//   arrTS.forEach(item => {
//     //append to divType
...
//     itemHolderUl.appendChild(itemHolderLi);
//   });
//   divTypeTS.appendChild(itemHolderUl);
//   //----------------------------------------------------------------------
//   let divTypeAS = document.createElement("div");
//   divTypeAS.classList.add("food__menu--type");
//   divTypeAS.textContent = "Asian Snacks";
...
//     divItem.appendChild(divName);
//     divItem.appendChild(divPrice);
//     divTypeAS.appendChild(divItem);
//   });

//   // ------------------------------------------------ Drinks
//   let divTypeD = document.createElement("div");
//   divTypeD.classList.add("food__menu--type");
//   divTypeD.textContent = "Drinks";

//   arrD.forEach(category => {
//     let divCateD = document.createElement("div");
//     divCateD.classList.add("food__menu--category");
//     divCateD.textContent = Object.keys(category)[0];
//     divTypeD.appendChild(divCateD);
//     category[Object.keys(category)[0]].forEach(item => {
//       //append to divType
//       let divItem = document.createElement("div");
//       divItem.classList.add("food__menu--item");
...
//       divItem.appendChild(divName);
//       divItem.appendChild(divPrice);
//       divTypeD.appendChild(divItem);
//     });
//   });

//   // ------------------------------------------------ Dessert
//   let divTypeDessert = document.createElement("div");
//   divTypeDessert.classList.add("food__menu--type");
//   divTypeDessert.textContent = "Dessert";

//   arrDessert.forEach(item => {
//     //append to divType
//     let divItem = document.createElement("div");
//     divItem.classList.add("food__menu--item");
...
//     divItem.appendChild(divName);
//     divItem.appendChild(divPrice);
//     divTypeDessert.appendChild(divItem);
//   });

//   foodMenu.appendChild(divTypeTS);
//   foodMenu.appendChild(divTypeAS);
//   foodMenu.appendChild(divTypeD);
//   foodMenu.appendChild(divTypeDessert);
// };
